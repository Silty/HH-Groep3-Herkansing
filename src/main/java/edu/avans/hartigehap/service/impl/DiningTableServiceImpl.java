...
public class DiningTableServiceImpl implements DiningTableService {
	...
	public void addOrderItem(DiningTable diningTable, MenuItem menuItem) {
		diningTable.getCurrentBill().getCurrentOrder().addOrderItem(menuItem);
	}
	
	public void addDecoratedOrderItem(DiningTable diningTable, OrderOption orderOption) {
		diningTable.getCurrentBill().getCurrentOrder().getOrderItems().add(orderOption);
	}
	
	public void saveBaseOrderItem(OrderOption orderOption) {
		baseOrderItemRepository.save(orderOption);
	}
	
	public void saveBaseOrderItem(OrderItem orderItem) {
