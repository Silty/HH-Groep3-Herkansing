...
public abstract class MenuItem extends DomainObjectNaturalId {
	...
	// To save as String in Database
	@Enumerated(EnumType.STRING)
	private MenuType type;
	
	public enum MenuType {
		Meal, Drink, MealOption
	}
	...
	@ManyToMany
	private Collection<MealOption> mealOptions = new ArrayList<MealOption>();
	
	public MenuItem(String id, String imageFileName, int price, MenuType type) {
		super(id);
	...
	public void addMealOptions(Collection<MealOption> mealOptions) {
